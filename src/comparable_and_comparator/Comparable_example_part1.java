...
public class Comparable_example_part1 {
    public static void main(String[] args) {
        ...
        //collection.sort use comparable internally
        ...
        //Java internally uses the compareTo method (defined in the Movie class) to compare the objects and sort the list.
